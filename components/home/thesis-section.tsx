          ...
          <div className="col-span-12 lg:col-span-8 lg:col-start-2 xl:col-span-7 xl:col-start-3">
            <div className="relative max-w-[48rem]">
              <p
                ...
                className="type-label mb-7 inline-flex items-center gap-3 text-text-muted/90 sm:mb-9 lg:absolute lg:left-[2%] lg:top-[0.35rem] lg:mb-0"
              >
              ...
              <div className="lg:pl-[11.5rem]">
                <div
                  ...
                  className="max-w-[34rem] lg:max-w-[38rem] xl:max-w-[40rem]"
                >
                  <h2
                    id="thesis-heading"
                ...
                <div
                  ...
                  className="mt-9 max-w-[23.5rem] sm:mt-11 sm:max-w-[26rem] lg:mt-13 lg:ml-[8.75rem] lg:max-w-[25rem] xl:ml-[9.5rem] xl:max-w-[25.5rem]"
                >
